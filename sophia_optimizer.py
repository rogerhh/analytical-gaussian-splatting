...
class SophiaOptimizer:
    ...
    def get_update(self, g, JTJv_func, z_gen_func, use_D_exact=False, D_exact_func=None):
        self.iter += 1
        ...
        if self.iter % self.diagonal_update_interval == 0 or not self.diagonal_initialized:
            ...
            self.update_diagonal(JTJv_func, z_gen_func, use_D_exact, D_exact_func)
    ...
    def update_diagonal(self, JTJv_func, z_gen_func, use_D_exact=False, D_exact_func=None):
        self.total_D_iter += 1
        beta2 = self.betas[1]
